...
import AbstractFactory.Factory.DellPartsFactory;
import AbstractFactory.Factory.PartsFactory;
import Computers.Utils.ComputerBrand;
import Computers.Utils.ComputerType;

public class DellComputerStore extends ComputerStore {

    @Override
    protected Computer createComputer(ComputerType computerType) {
        PartsFactory partsFactory = DellPartsFactory.getInstance();
